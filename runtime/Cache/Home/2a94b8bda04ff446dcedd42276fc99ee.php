...
<head>
    ...
    <title>fis3-thinkphp DEMO</title>
    ...
    <!-- 加载同步的css -->
    <link href="/public/static/css/tooplate_style.css" rel="stylesheet"/>
    <link href="/public/static/css/coda-slider.css" rel="stylesheet" />

    <!-- 加载同步的js -->
    <script src="/public/static/js/jquery-1.2.6.js" ></script>
...
<body>
  <div id="slider">
    ...
    <div id="header">
        <h1><a href="#"><img src="/public/static/images/tooplate_logo.png" title="Notebook Template - tooplate.com" alt="Notebook free html template" /></a></h1>
    </div>    
  ...
  <div class="content_section">
    <h2>FIS3 纯php解决方案DEMO</h2>
    <img src="/public/static/images/tooplate_image_01.jpg" alt="Image 01" class="image_wrapper image_fl" />
  ...
  <div class="content_section">
    <h1>About Us</h1>
    <img src="/public/static/images/tooplate_image_02.jpg" alt="Image 02" class="image_wrapper image_fl" />
  ...
  <img src="/public/static/images/tooplate_image_02.jpg" alt="Image" class="image_wrapper image_fr" />
  ...
  <div id="gallery_container">
    <div class="gallery_box float_l">
      <h4>Project One</h4>
      <a href="#"><img src="/public/widget/gallery/img/image_01.jpg" alt="Project 1" /></a> </div>
    <div class="gallery_box float_r">
      <h4>Project Two</h4>
      <a href="#"><img src="/public/widget/gallery/img/image_02.jpg" alt="Project 2" /></a> </div>
    <div class="gallery_box float_l">
      <h4>Project Three</h4>
      <a href="#"><img src="/public/widget/gallery/img/image_03.jpg" alt="Project 3" /></a> </div>
    <div class="gallery_box float_r">
      <h4>Project Four</h4>
      <a href="#"><img src="/public/widget/gallery/img/image_04.jpg" alt="Project 4" /></a> </div>
    <div class="gallery_box float_l">
      <h4>Project Five</h4>
      <a href="#"><img src="/public/widget/gallery/img/image_05.jpg" alt="Project 5" /></a> </div>
    <div class="gallery_box float_r">
      <h4>Project Six</h4>
      <a href="#"><img src="/public/widget/gallery/img/image_06.jpg" alt="Project 6" /></a> </div>
  ...
  <div id="footer">
    ...
    <div id="social_box">
        <a href="#"><img src="/public/widget/footer/logos/facebook.png" alt="facebook" /></a>
        <a href="#"><img src="/public/widget/footer/logos/flickr.png" alt="flickr" /></a>
        <a href="#"><img src="/public/widget/footer/logos/myspace.png" alt="myspace" /></a>
        <a href="#"><img src="/public/widget/footer/logos/twitter.png" alt="twitter" /></a>
        <a href="#"><img src="/public/widget/footer/logos/youtube.png" alt="youtube" /></a>
    </div>
